...
export class PlaybackEngine {
  constructor(onFrame, onEnd) {
    ...
    // Reusable output object — avoids a GC allocation every rAF tick
  ...
  _interpolate(t) {
    ...
    if (t <= kfs[0].t)              return this._setFrame(kfs[0], t);
    if (t >= kfs[kfs.length - 1].t) return this._setFrame(kfs[kfs.length - 1], t);
