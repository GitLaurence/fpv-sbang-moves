export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero pa-kabilang panig ang roll, kasabay ng kabaligtaran na yaw correction. Mahalaga ang pag-aaral nito para sa parehong direksyon ng knife edge transitions.',
  tips: [
    'I-roll patungo sa kabilang direksyon kumpara sa regular na Knife Edge — exactly -90°',
    'Reverse ang yaw correction direction para mapanatili ang heading habang naka-hold',
    'Mas mataas na throttle ang kailangan sa hold dahil sa pagkawala ng vertical lift',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
  ...
  keyframes: [
    ...
    // Knife edge hold — reversed yaw to maintain heading, slight pitch correction
