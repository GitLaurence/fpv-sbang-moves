export default {
  ...
  youtubeStart: 0,
  description: 'Kabaligtaran ng Knife Edge — mag-roll papuntang -90° at panatilihin ang heading gamit ang opposite yaw. Mahalaga ito para magkaroon ng symmetric na kontrol sa magkabilang roll axis.',
  tips: [
    'I-practice ito pagkatapos ma-master ang regular Knife Edge — kabaligtaran ang roll at yaw input',
    'Manatili sa eksaktong -90° lang ang roll — huwag lumagpas',
    'Konsistent ang throttle hold para hindi bumagsak ang altitude habang naka-knife edge',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
