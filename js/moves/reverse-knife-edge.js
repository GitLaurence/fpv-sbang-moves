export default {
  ...
  youtubeStart: 0,
  description: '90° roll papuntang kabilang gilid kumpara sa regular na Knife Edge. Pareho ang konsepto — yaw para mapanatili ang heading habang naka-roll — pero baligtad ang direksyon ng roll at yaw.',
  tips: [
    'Mag-roll ng exactly -90° sa kabilang direksyon kumpara sa regular na Knife Edge',
    'Yaw input din ay baligtad — practice ito hanggang naging muscle memory ang dalawang direksyon',
    'Konsistent ang throttle hold para hindi bumagsak ang altitude habang naka-edge',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
