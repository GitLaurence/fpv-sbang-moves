export default {
  ...
  youtubeStart: 0,
  description: 'Kabaligtaran ng Knife Edge — 90° roll papunta sa kabilang gilid, gamit ang opposite yaw para mapanatili ang heading. Magandang pagsasanay para sa parehong direksyon ng roll authority.',
  tips: [
    'Mag-roll ng exactly -90° sa kabilang direksyon kumpara sa regular Knife Edge',
    'I-reverse ang yaw direction para mapanatili ang heading habang naka-edge',
    'Pantay ang throttle hold sa parehong panig — practice both directions para balanced',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
  ...
  keyframes: [
    ...
    // Knife edge hold (opposite side) — opposite yaw to maintain heading
