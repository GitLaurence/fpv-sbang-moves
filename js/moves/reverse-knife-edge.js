export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero kabaligtaran ang direksyon ng roll — 90° patungo sa kaliwa, may opposite yaw para mapanatili ang heading. Mahalaga para sa balanseng control sa magkabilang axis.',
  tips: [
    'Master muna ang regular Knife Edge bago ito subukan — kabaligtaran ang lahat ng input dito',
    'Karamihan ng pilots ay mas mahina sa isang direksyon — equal practice sa both sides para balanse',
    'Pareho rin ang throttle hold sa regular knife edge — ~80% para manatiling level',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
