export default {
  ...
  youtubeStart: 0,
  description: 'Variant ng Knife Edge kung saan kabaligtaran ang direksyon ng roll — 90° roll sa kabilang panig, pinananatili gamit ang yaw. Parehong prinsipyo ng regular Knife Edge, pero kabaligtaran ang muscle memory.',
  tips: [
    'Kabaligtaran ng normal na Knife Edge ang roll direction — mag-ingat sa confusion ng input',
    'Gamitin ang yaw sa kabaligtarang direksyon din para mapanatili ang heading',
    'Mag-practice muna ng regular Knife Edge bago ito, para maging malinaw ang contrast',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
  ...
  keyframes: [
    ...
    // Roll to -90° (opposite side of standard Knife Edge)
