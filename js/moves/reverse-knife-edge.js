export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero pakaliwa naman ang direksyon ng roll, kasama ang kabaligtaran na yaw correction. Mas mahirap dahil hindi ito ang natural na direksyon ng karamihan ng pilots.',
  tips: [
    'Mag-roll ng exactly -90° papuntang kabilang panig — opposite ng karaniwang knife edge',
    'Gamitin ang kabaligtaran na yaw para mapanatili ang heading habang naka-reverse na roll',
    'Magsanay muna ng regular na Knife Edge bago subukan ang reverse direction',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
