export default {
  ...
  youtubeStart: 0,
  description: 'Tulad ng Knife Edge pero papunta sa kabilang gilid — mag-roll patungo sa -90° at gamitin ang yaw sa kabaligtarang direksyon para mapanatili ang heading. Mas mahirap dahil karamihan ng pilots ay mas sanay sa isang side lang.',
  tips: [
    'I-mirror ang lahat ng inputs ng regular Knife Edge — kabaligtaran ang roll at yaw',
    'Magsanay muna sa parehong direksyon nang hiwalay bago pagsamahin sa isang flowline',
    'Mas mataas na throttle ang kailangan habang naka-knife edge para hindi bumaba',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
