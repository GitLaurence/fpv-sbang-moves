export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero pasalungat ang direksyon ng roll — 90° roll patungo sa kabilang gilid, may kabaligtarang yaw para mapanatili ang heading. Mahalaga ang reverse knife edge para hindi laging parehong gilid lang ang ina-train.',
  tips: [
    'I-mirror ang roll input ng regular knife edge — kabaligtarang direksyon ng roll',
    'Kabaligtarang yaw din ang gamitin para mapanatili ang heading habang naka-knife edge',
    'Practice ang parehong gilid nang pantay — huwag lang isang direksyon palagi',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
  ...
  keyframes: [
    ...
    // Roll to -90° — kabaligtaran ng regular knife edge
    { t: 0.4,  throttle: 0.65, yaw:  0.00, pitch:  0.00, roll: -0.75 },
    { t: 0.7,  throttle: 0.72, yaw:  0.00, pitch:  0.00, roll: -0.55 },
    // Knife edge hold — kabaligtarang yaw para mapanatili ang heading
