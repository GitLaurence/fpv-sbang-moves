export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero pakaliwa ang roll at kabaligtaran ang yaw compensation — parang "mirror" na bersyon. Magandang pagsanayan para sa parehong direksyon ng knife edge.',
  tips: [
    'I-mirror lang ang muscle memory ng regular Knife Edge — roll papunta sa kabilang direksyon',
    'Gamitin ang opposite yaw para mapanatili ang heading habang naka-hold sa 90°',
    'Practice sa magkabilang direksyon para hindi paborito ang isang side lang',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
