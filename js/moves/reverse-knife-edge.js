export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero papuntang kabilang direksyon ang roll — 90° roll patungo sa opposite side habang ang yaw ang nag-iingat ng heading. Mahalaga para masanay sa knife edge sa parehong direksyon.',
  tips: [
    'Roll patungo sa kabilang side kumpara sa regular Knife Edge — practice ang dalawang direksyon',
    'Opposite din ang direksyon ng yaw correction kumpara sa regular Knife Edge',
    'Mataas na throttle kailangan habang naka-knife-edge para manatili sa altitude',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
  ...
  keyframes: [
    ...
    // Roll to -90° (opposite side from regular Knife Edge)
