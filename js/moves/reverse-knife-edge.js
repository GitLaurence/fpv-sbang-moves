export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero sa kabilang direksyon — 90° roll papunta sa opposite side, may opposite yaw para mapanatili ang heading. Magandang pares sa regular Knife Edge para sa magkabilang-direksyon na practice.',
  tips: [
    'Mag-roll ng exactly -90° sa kabilang direksyon ng regular Knife Edge',
    'I-reverse ang yaw correction — kabaligtaran ng regular Knife Edge',
    'Mag-practice ng pareho ng direksyon para hindi maging one-sided ang skill',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
