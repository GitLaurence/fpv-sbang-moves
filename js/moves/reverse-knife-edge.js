export default {
  ...
  youtubeStart: 0,
  description: 'Kapareho ng Knife Edge pero pa-kabilang gilid ang roll — 90° patungong kaliwa imbes na kanan. Salungat din ang yaw correction para mapanatili ang heading.',
  tips: [
    'Mag-roll ng exactly -90° patungo sa kabaligtarang direksyon ng regular Knife Edge',
    'Salungat ang direksyon ng yaw correction kumpara sa normal na Knife Edge — i-practice pareho ang dalawang gilid',
    'Mas mataas na throttle ang kailangan para manatiling level habang naka-knife edge',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
