export default {
  ...
  youtubeStart: 0,
  description: 'Kabaligtaran ng Knife Edge — 90° roll papunta sa kabilang direksyon, may kabaligtarang yaw para mapanatili ang heading. Magandang pagsasanay para sa symmetric na control sa magkabilang roll direction.',
  tips: [
    'Mag-roll ng exactly -90° — kabaligtaran ng direksyon ng regular Knife Edge',
    'I-reverse ang yaw input kumpara sa regular Knife Edge para mapanatili ang heading',
    'Mas mahirap ito kung ang isang direksyon lang ang nasanay mo — practice sa magkabilang banda',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
