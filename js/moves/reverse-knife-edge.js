export default {
  ...
  youtubeStart: 0,
  description: 'Tulad ng Knife Edge pero papunta sa kabilang direksyon — mag-roll ng -90° at panatilihin ang heading gamit ang opposite yaw. Magandang i-pares sa regular Knife Edge para sa S-curve na linya.',
  tips: [
    'Kabaligtaran ang roll input kumpara sa regular Knife Edge — -90° sa halip na +90°',
    'Kabaligtaran din ang yaw correction para mapanatili ang heading',
    'I-practice sa parehong direksyon hanggang maging instinctive ang dalawa',
  ],
  phases: [
    { t: 0.0, label: 'Entry' },
    { t: 0.4, label: 'Roll -90°' },
