...
export class FpvCamRenderer {
  ...
  _drawScene(sim) {
    ...
    // Motion blur: fade the previous frame toward black instead of a hard
    // clear, so fast motion leaves a faint trail — no pixel readback needed,
    // the GPU handles compositing the fill over whatever is already there.
