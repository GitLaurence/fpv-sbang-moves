...
export class FpvCamRenderer {
  ...
  _drawScene(sim) {
    ...
    // Motion blur: fade the existing (previous-frame) pixels toward black
    // instead of reading them back — GPU handles the compositing, no
    // getImageData/putImageData readback needed.
