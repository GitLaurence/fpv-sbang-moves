...
export class YouTubePlayer {
  ...
  /** True once the underlying YT.Player has fired onReady. */
  ...
  /** Register a callback fired when the video fails to load — cb(ytErrorCode) */
    ...
    this._player = new YT.Player(this._elemId, {
      ...
      events: {
        ...
        onError: (ev) => {
          ...
          // plus a dedicated error callback so the UI can surface a message.
